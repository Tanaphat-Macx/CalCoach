      ...
      <div style={{ maxWidth:480, margin:"0 auto", padding:"12px 16px 0" }}>
        ...
        {tab === "weight" && <>
          ...
          {(() => {
            ...
            const allRows = [
              { d: todayD, ...foodConsumed, isToday: true },
              ...[...foodLogs].reverse(),
            ];
            return (
              <div style={CARD}>
                <div style={SEC}>บันทึกการกิน</div>
                <div style={{ display:"grid", gridTemplateColumns:"52px 1fr 1fr 1fr 1fr", gap:4, paddingBottom:8, borderBottom:"1px solid #1e3a50", marginBottom:2 }}>
                  <div/>
                ...
                <div style={{ maxHeight:200, overflowY:"auto" }}>
                  {allRows.map((l,i) => (
                    <div key={l.d} style={{ display:"grid", gridTemplateColumns:"52px 1fr 1fr 1fr 1fr", gap:4, padding:"7px 0", borderBottom:i<allRows.length-1?"1px solid #1e3a50":"none", alignItems:"center" }}>
